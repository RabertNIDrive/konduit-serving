...
@NotThreadSafe
public class PytorchTestPythonImageInput extends BaseMultiNumpyVerticalTest {
    ...
    public JsonObject getConfigObject() throws Exception {
       ...
       System.out.println("pythonCodePath--"+pythonCodePath);
    ...
    public void testInferenceResult(TestContext context) throws Exception {
       ...
       System.out.println("imageArray Java "+imageFile);
...
/*        File imageFile = new ClassPathResource("data/test_img.png").getFile();
        ...
        INDArray outputArray = nd.getNdArray().reshape();
        System.out.println("Tess"+outputArray);
        assertEquals(7, outputArray);
