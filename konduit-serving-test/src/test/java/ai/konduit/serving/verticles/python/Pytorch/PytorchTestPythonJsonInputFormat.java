...
@NotThreadSafe
public class PytorchTestPythonJsonInputFormat extends BaseMultiNumpyVerticalTest {
    ...
    public JsonObject getConfigObject() throws Exception {
        ...
        PythonConfig pythonConfig = PythonConfig.builder()
                ...
                .pythonInput("JsonInput1", PythonVariables.Type.NDARRAY.name())
    ...
    public void testInferenceResult(TestContext context) throws Exception {
        ...
        requestSpecification.port(3000);
        JsonObject jsonObject = new JsonObject();

       // String jsonConfig = new ClassPathResource("Json/IrisY.json").getFile().getAbsolutePath();
        File jsonConfig = new ClassPathResource("Json/IrisY.json").getFile();
